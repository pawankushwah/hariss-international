...
//   maxLength?: number;
//   setSelectedCountry?: (country: { name?: string; code?: string; flag?: string; iso2?: string }) => void;
//   selectedCountry?: { name?: string; code?: string; flag?: string; iso2?: string };
// };
...
//                 setPhone(v);
//                 // forward the change to parent handler
//                 safeOnChange(e);
//               };
...
//       <PhoneInput
//         country={selectedCountry?.iso2 || "us"}
//         value={value as string}
//         onChange={(phone: string, countryData: any) => {
//           setPhone(phone);
//           // guard access to countryData properties since the incoming type can be {} | CountryData
//           setSelectedCountry?.({
//             name: countryData?.name,
//             code: countryData?.dialCode ? `+${countryData.dialCode}` : undefined,
...
//           disabled,
//         }}
//         buttonClass="!bg-white !border !border-gray-300 !rounded-l-md !px-2 !py-2 focus:!border-gray-500 focus:!ring-1 focus:!ring-gray-400"
//         dropdownClass="!bg-white !border !border-gray-200 !shadow-lg !rounded-md max-h-64 overflow-auto z-50"
//         containerClass="!w-full"
//         inputClass={`!w-full !pl-14 !border !border-gray-300 !h-[44px] !rounded-md focus:!border-gray-500 focus:!ring-1 focus:!ring-gray-400 !text-gray-900 placeholder-gray-400 disabled:!bg-gray-100 ${
//           error ? "!border-red-500" : ""
//         }`}
//         searchClass="!border !border-gray-300 !rounded-md !p-2 !text-sm !mb-2 focus:!border-gray-500 focus:!ring-1 focus:!ring-gray-400"
