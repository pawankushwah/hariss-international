...
//         merchandiser: yup.array().of(yup.string()).min(1, "At least one merchandiser is required"),
...
//           merchandiser:existing.merchandiser?.map((r: Merchandiser) => String(r.id)) || [],
...
//       setForm((prev) => ({ ...prev, merchandiser: normalized ? [normalized] : [] }));
//     } else {
//       setForm((prev) => ({
//         ...prev,
//         [field]: value,
...
//                         onChange={(e: any) =>{
//                          setForm({...form,merchandiser:e.target.value})
