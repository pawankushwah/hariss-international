...
const data = new Array(100).fill(null).map((_, i) => ({
    id: (i + 1).toString(),
    Warehpousecode: "AC0001604",
    sapId: "-",
    WarehouseName: `Abdul Retail Shop ${i + 1}`,
    ownerName: `Musinguzi Abdul`,
    registrationNumber: `DP0157865`,
    depotLocation: "Ggaba",
    ownerContactNumber: "0789517400,",
...
const columns = [
    ...
    { key: "sapId", label: "Sap ID" },
    {
        ...
        render: (row: TableDataType) => (
            <Link
                href={`/master/warehouse/${row.id}/overview`}
    ...
    { key: "ownerContactNumber", label: "Owner Contact Number", width: 150 },
                        ...
                        header: {
                            ...
                            actions: [
                                <SidebarBtn
                                    ...
                                    label="Add Warehouse"
                                    href="/master/warehouse/addwarehouse"
                                />,
                            ],
                        },
                        footer: {
